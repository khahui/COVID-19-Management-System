...
import 'viewVaccinationStatus.dart';

class viewVaccinationDetailsPage extends StatefulWidget {
  const viewVaccinationDetailsPage({Key? key}) : super(key: key);

  @override
  State<viewVaccinationDetailsPage> createState() =>
      _viewVaccinationDetailsPageState();
}

class _viewVaccinationDetailsPageState
    extends State<viewVaccinationDetailsPage> {
