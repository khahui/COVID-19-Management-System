...
class viewVaccinationStatusPage extends StatefulWidget {
  const viewVaccinationStatusPage({Key? key}) : super(key: key);
...
class _viewVaccinationStatusPageState extends State<viewVaccinationStatusPage> {
