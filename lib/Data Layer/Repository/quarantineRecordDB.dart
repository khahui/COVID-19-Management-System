...
import '../Model/MOHStaffUserQuarantineRecordModel.dart';
...
class Db {
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute(' '
        ' CREATE TABLE User(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,age INTEGER,symptoms TEXT,bodycondition TEXT, quarantineplace TEXT) '
        ' ');

    await db.execute(' '
        ' CREATE TABLE Admin(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,age INTEGER,symptoms TEXT,bodycondition TEXT, quarantineplace TEXT) '
        ' ');
  }
